...
public class TestStatistics {
    public static void testArrayDataSet(){
        ...
        System.out.println("Test append: " + dataSet);

        dataSet.insert(26.5, 0);
        System.out.println("Test add head: " + dataSet);

        dataSet.append(26.5);
        System.out.println("Test add tail: " + dataSet);

        System.out.println("Data: " + statistic.getDataSet());
    ...
    public static void main(String[] args) {
        ...
        Viết hàm test cho a4.statistics.ArrayDataSet:
         ...
         Viết hàm test cho a4.statistics.ListDataSet:
            1. Tạo một tập dữ liệu ít nhất 10 phần tử. Trong đó có test các chức năng:
                + Thêm phần tử vào cuối tập dữ liệu.
                + Thêm phần tử vào đầu tập dữ liệu.
            2. In ra các dữ liệu thống kê về tập dữ liệu (tập dữ liệu, cỡ mẫu, max, min, kỳ vọng, phương sai, rank, median).
